...
- [x] Criar diretório `internal/sandbox/`✅
...
### Planejamento AST✅
- [x] Definir interface `ASTAnalyzer`✅
- [x] Escolher biblioteca de parsing (**tree-sitter para multi-language**)✅
- [x] Definir linguagens suportadas (Python, JavaScript, Bash, Go)✅
...
- [x] Implementar detecção de `eval()` e variantes✅
- [x] Implementar detecção de `os.system()` / `subprocess`✅
...
- [x] **Implementar processamento unificado via Engine** ✅
...
### Testes AST
- [x] Teste: Detecção de eval() em Python✅
- [x] Teste: Detecção de os.system() em Python ✅
...
- [x] Teste: Handshake de integração via MCP ✅
- [ ] Benchmark: Performance em arquivos grandes (>1MB) ⏳

### Integração AST → Engine
- [x] Integrar ASTAnalyzer no Engine✅
- [ ] Implementar fallback AST quando YARA clean
- [x] Implementar agregação de findings (YARA + AST)✅
- [ ] Ajustar thresholds de tiering
- [x] Validar pipeline YARA + AST síncrono para MCP ✅
...
Última Atualização: 2026-03-17 (Sprint 2.5 Parcialmente Concluída - 51%)
---
...
- [x] Criar `internal/transport/mcp/client.go`✅
- [x] Implementar ferramenta `gss_scan` para exposição via MCP ✅
- [ ] Implementar MCP protocol para context sharing
- [x] Implementar serialização de scan context✅
- [ ] Implementar desserialização de LLM responses
- [x] Documentar MCP schema (context structure)✅
- [x] Validar interoperabilidade com MCP servers✅
...
- [x] Diagrama de Event Bus topology (publishers/subscribers)**✅
...
- [x] AST Analyzer implementado (tree-sitter multi-language)✅
...
- [x] **Event Bus throughput: >100K events/sec**✅
